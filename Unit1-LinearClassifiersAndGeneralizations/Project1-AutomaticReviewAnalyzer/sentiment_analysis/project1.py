...
def classifier_accuracy(
    ...
    ## debug for Problem8 The most explanatory unigrams
#     print('theta dim: ' + str(parameters[0].shape))
#     print('theta type: ' + str(type(parameters[0])))
#     parameters[0][::-1].sort()
    
#     for i in range(10):
#         print(str(parameters[0][i]) + '\n')
    ##
    ...
    traing_accuracy = accuracy(training_predections, train_labels)
    validation_accuracy = accuracy(validation_predecions, val_labels)
...
#### add for Problem 9. Remove Stop Words ####
def bag_of_words_remove_stop_words(texts, stopwords):
    """
    Inputs a list of string reviews
    Returns a dictionary of unique unigrams occurring over the input
...
def classifier_parameter(
    ...
    Returns: A tuple in which the first element is the theta of the
    trained classifier on the training data and the second element is the
    theta_0 of the trained classifier on the training data
    """
    # Your code here
    parameters = classifier(train_feature_matrix, train_labels, **kwargs)
    return parameters
