...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        print('hidden_layer_activation: ' + str(hidden_layer_activation))

        print('self.hidden_to_output_weights: ' + str(self.hidden_to_output_weights))
        ...
        print('activated_output: ' + str(activated_output))
        ...
        print('y: ' + str(y))
        print('output_layer_error: ' + str(output_layer_error))
        ...
        print('hidden_layer_error: ' + str(hidden_layer_error))
        ...
        print('hidden_to_output_weights: ' + str(self.hidden_to_output_weights.shape))
