...
# print('run_softmax_on_MNIST_mod3 START')
...
## print('START run_softmax_on_MNIST_pca')
...
print('START run_softmax_on_MNIST_pca10_cubic')
print('softmax test_error_pca10_cube=', run_softmax_on_MNIST_pca10_cubic(temp_parameter=1))
